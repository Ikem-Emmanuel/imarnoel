	...
	render() {
		...
		return (
			<div class='min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-5 py-5'>
				<div className='lg:w-3/4 lg:mx-auto mt-10 bg-gray-900 shadow-lg rounded-lg overflow-hidden'>
					<div class='border-b border-gray-700 px-8 sm:px-8 py-3'>
						<div class='inline-block w-3 h-3 mr-2 rounded-full bg-red-700'></div>
						<div class='inline-block w-3 h-3 mr-2 rounded-full bg-yellow-500'></div>
						<div class='inline-block w-3 h-3 mr-2 rounded-full bg-green-600'></div>
					</div>
					<div className='sm:items-center flex items-center justify-center md:flex md:shrink-0 px-2 py-3 m-3'>
						<div className='sm:items-center md:flex md:shrink-0 px-2 py-3 m-3'>
							...
							<div className='my-3'>
								<div className='ml-3 pt-1 px-3'>
									<p className='text-xl leading-tight text-gray-500 font-bold'>
										{title}
									</p>
